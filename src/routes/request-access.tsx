    ...
    try {
      ...
      toast.error(
        err instanceof Error
          ? err.message
          : "Couldn't find that workspace admin. Double-check their email.",
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="grid min-h-screen place-items-center p-6">
        <div className="max-w-md text-center space-y-3">
          ...
          <p className="text-sm text-muted-foreground">
            We've notified your workspace admin. You'll get an email once approved, then you can
            sign in.
          </p>
        </div>
      </div>
    ...
    <div className="grid min-h-screen place-items-center p-6">
      <form onSubmit={submit} className="w-full max-w-md space-y-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Ask your workspace admin to add you to their AscendOS team.
          </p>
        </div>
        ...
        <div className="space-y-1.5">
          <Label>Workspace admin's email</Label>
          <Input
            type="email"
            required
