                      ...
                      <tr key={o.offer} className="border-t border-border/70 hover:bg-muted/20">
                        ...
                        <td className="p-3">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-2xs font-mono w-12 text-right">{sharePct.toFixed(1)}%</span>
                          </div>
                        </td>
                      </tr>
                    );
            ...
            {editing && (
              <>
                ...
                <div className="border-t border-border pt-4 mt-2 space-y-2">
                  <div className="flex items-center gap-1.5 text-2xs uppercase tracking-wider text-muted-foreground"><Sparkles className="h-3 w-3" /> Pre-close summary</div>
